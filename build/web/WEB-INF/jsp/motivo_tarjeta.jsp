<%-- 
    Document   : motivo_tarjeta
    Created on : 17/07/2019, 12:28:48 PM
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <center><h3><b>Catálogo de movimientos de tarjetas</b></h3></center>
                        </div>
                    </div>
                    <div class="col-lg-10">
                        <div class="form-group">
                            <button class="btn btnEditAdd" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                ...
                                <tbody >
                                    <c:forEach items="${datos}" var="dato">
                                        <tr id="${dato[0]}">
                                            <c:if test="${dato[1] == 0}">
                                                <td>Habilitada</td>
                                                <td data-target="movimiento" hidden>${dato[1]}</td>
                                            </c:if>
                                            <c:if test="${dato[1] == 1}">
                                                <td>Deshabilitada</td>
                                                <td data-target="movimiento" hidden>${dato[1]}</td>
                                            </c:if>
                                            <td data-target="motivo">${dato[2]}</td>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form action="motivo_tarjeta_insert.htm" method="post" accept-charset="ISO-8859-1">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="mtMovimiento" name="mtMovimiento" value="0" required>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Habilitación
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="mtMovimiento" name="mtMovimiento" value="1" required>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Deshabilitación
                                                </label>
                                            </div> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 align-self-center">
                                            <input type="text" class="form-control" name="mtMotivo" id="mtMotivo" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="exampleModal2" role="dialog" >
            <div class="modal-dialog" role="document">
                <form action="motivo_tarjeta_update.htm" method="post" accept-charset="ISO-8859-1">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Actualizar nuevo motivo</h5>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">                                                                                                                                                                                                   
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="mtMovimiento" id="habilitado" value="0" required>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Habilitación
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="mtMovimiento" id="deshabilitado" value="1" required>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Deshabilitación
                                                </label>
                                            </div> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 align-self-center">
                                            <input type="text" id="motivo" name="mtMotivo" class="form-control" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
