<%-- 
    Document   : registro_tarjeta
    Created on : 1/08/2019, 01:58:05 PM
    Author     : Pavillion-Pc
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="tarjeta_excel.htm"><i class="menu-icon fa fa-file-excel-o" aria-hidden="true"></i>Subir archivo</a>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </nav>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content">
                <div class="row">                
                    ...
                    <div class="col-lg-12"> 
                        <form action="registro_tarjeta_insert.htm" method="post" name="myForm" accept-charset="ISO-8859-1" onsubmit="return(validateForm());">
                            <div class="bordes4">
                                ...
                                <div class="form-group row justify-content-center">
                                    ...
                                    <div class="col-sm-5 align-self-center">
                                        ...
                                        <p id="errorTipo" style="color: red; font-size: 12px; height: 0px;"></p>
                                    </div>
                                </div>
                                <div class="form-group row justify-content-center">
                                    <div class="col-sm-3 align-self-center">
                                ...
                                <div class="form-group row justify-content-center">
                                    ...
                                    <div class="col-sm-5 align-self-center">
                                        ...
                                        <p id="errorEmision" style="color: red; font-size: 12px; height: 0px;"></p>
                                    </div>
                                </div>
                                <div class="form-group row justify-content-center">
                                    <div class="col-sm-3 align-self-center">
                                ...
                                <div class="form-group row justify-content-center">
                                    ...
                                    <div class="col-sm-5 align-self-center">
                                        <input type="text" class="form-control" name="lugar" autocomplete="off" pattern="[A-Za-záéíóúñÑÁÉÍÓÚ,\s]{1,800}">
                                        <p id="errorLugar" style="color: red; font-size: 12px; height: 2px;"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <center><button type="submit" class="btn btn btnGuardar">GUARDAR</button></center>
                            </div>
                        </form>                        
                    </div>                    
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                if (parameter === "1") {
                    toastr.success('Tarjeta registrada!', 'Exito', {
